...
public class InventoryMain {
	...
	public static void main(String[] args) {
		...
		inv.addPart(null, "01011", "1/2\" Bolt", "Sears", 100);
		inv.addPart(null, "X3599", "1\" Laminate Edging (Hot Pink)", "Plastics R Us", 50);
		inv.addPart(null, "02949", "1/4\" Plywood 10x10", "", 10);
